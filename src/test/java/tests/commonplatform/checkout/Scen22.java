 ...
 */
public class Scen22 extends BaseTest {
    ...
    @Test
    public void placeOrderAndEditMethodOfPayment() throws Exception {
        ...
        String name="Hello World"+new Random().nextInt(100000);
        reviewSubmitPage.editAndeditCreditCardName(name);
        AssertFailAndContinue(reviewSubmitPage.isPaymentNameEdited(name),"Landed on Place Order Page");
