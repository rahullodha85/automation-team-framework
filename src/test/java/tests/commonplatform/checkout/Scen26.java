 ...
 */
public class Scen26 extends BaseTest {
    WebDriver driver;
    ...
    public void forgotPasswordValidate() throws Exception {
        ...
        saksBagPage.clickCheckout().forgotPassword(TestData.LOGIN1);
        AssertFailAndContinue(saksBagPage.hasPasswordReset(TestData.LOGIN1),"Landed on Saks Bag Page");
