 ...
 */
public class Scen21 extends BaseTest {
    ...
    public void placeOrderWithPreOrderRegularEGCItem() throws Exception {
        ...
        driver.get(Config.getApplicationUrl()+"checkout/checkout.jsp?bmForm=add_saks_suggests_item_service_product_array&productCode="+TestData.PRODUCT6+"&itemQuantity=3&sku_id="+TestData.SKU6+"&type=REQUEST_ADD_TO_BAG");
        AssertFailAndContinue(productDetailsPage.isItemAdded(TestData.PRODUCT6),"Item has been added");
