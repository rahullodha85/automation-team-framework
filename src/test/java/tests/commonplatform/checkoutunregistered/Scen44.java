 ...
 */
public class Scen44 extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void placeOrderUnregUsePreOrderAndRegularItem() throws Exception {
        ...
        driver.get(Config.getApplicationUrl()+"checkout/checkout.jsp?bmForm=add_saks_suggests_item_service_product_array&productCode="+TestData.PRODUCT8+"&itemQuantity=1&sku_id="+TestData.SKU8+"&type=REQUEST_ADD_TO_BAG");
        ...
        AssertFailAndContinue(reviewSubmitPage.hasPreOrderItemInCart(TestData.PRODUCT8),"Has PreOrder  item in the cart");
