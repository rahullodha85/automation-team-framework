 ...
 */
public class Scen03 extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void placeOrderRegExistingShippingBillingAddress() throws Exception {
        ...
        reviewSubmitmPage.updateCartService(TestData.PRODUCTOFF1,1);
        shippingBillingPage.editAndChooseExistingShippingAddress(1);
        AssertFailAndContinue(reviewSubmitPage.hasShippingAddressUpdated(""),"Shipping address is Added");
        shippingBillingPage.editAndChooseExistingBillingAddress(1);
        AssertFailAndContinue(reviewSubmitPage.hasBillingAddressUpdated(""),"Billing address is Added");
