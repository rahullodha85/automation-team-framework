package tests.commonplatform.mobile.borderfreeoff5th.unreg;
...
public class Scen03 extends BaseTest {
    ...
    private static final Logger logger = Logger.getLogger(Scen03.class);
    ...
    @Test
    public void placeOrdermUnRegGuestUserEditShippingBilling() throws Exception {
        ...
        reviewSubmitmPage.editAndEditExistingShippingAddress(bldNo+"Vesey St");
        AssertFailAndContinue(reviewSubmitmPage.hasShippingAddressUpdated(bldNo),"Shipping address is edited");
        reviewSubmitmPage.editAndEditExistingBillingAddress(bldNo+"Vesey St");
        AssertFailAndContinue(reviewSubmitmPage.hasBillingAddressUpdated(bldNo),"Billing address is edited");
