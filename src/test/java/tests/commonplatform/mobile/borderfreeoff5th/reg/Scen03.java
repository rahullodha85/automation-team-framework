...
public class Scen03 extends BaseTest {
    ...
    @Test
    public void placeOrdermRegExistingShippingBillingAddress() throws Exception {
       ...
       // reviewSubmitmPage.emptyCartService(1);
        ...
        shippingBillingmPage.editAndChooseExistingShippingAddress(1);
        AssertFailAndContinue(shippingBillingmPage.hasShippingAddressUpdated(""),"Shipping address is Added");
        shippingBillingmPage.editAndChooseExistingBillingAddress(1);
        AssertFailAndContinue(shippingBillingmPage.hasBillingAddressUpdated(""),"Billing address is Added");
