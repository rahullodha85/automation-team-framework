package tests.commonplatform.mobile.borderfreeoff5th.reg;
...
public class Scen06 extends BaseTest {
    ...
    @Test
    public void placeOrdermRegHasDefaultBillingShippingChangeContextChooserAndAddItemOnReviewSubmit() throws Exception {
       ...
       /* driver.get(Config.getApplicationUrl()+"checkout/checkout.jsp?bmForm=add_saks_suggests_item_service_product_array&productCode="+TestData.PRODUCT2+"&itemQuantity=1&sku_id="+TestData.SKU1+"&type=REQUEST_ADD_TO_BAG");
...
*/
        ...
        AssertFailAndContinue(reviewSubmitmPage.hasPlaceOrder(),"Landed on Place Order mPage");
